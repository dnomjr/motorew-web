...
var _createFunctionsJs = require("./createFunctions.js");
var _changeSlideJs = require("./changeSlide.js");
var _touchSwipeJs = require("./touchSwipe.js");
var _scrollToJs = require("./scrollTo.js");
var _scrollToJsDefault = parcelHelpers.interopDefault(_scrollToJs);
var _toggleMenuJs = require("./toggleMenu.js");
var _toggleMenuJsDefault = parcelHelpers.interopDefault(_toggleMenuJs);
...
const swipePrevSlide = (0, _changeSlideJs.swipeNextSlide).bind("prev");
const date = new Date().getFullYear();
actualYear.textContent = date;
const init = function() {
    (0, _createFunctionsJs.createSlides)();
    (0, _createFunctionsJs.createSliderNavigation)();
};
init();
menuIcon.addEventListener("click", (0, _toggleMenuJsDefault.default));
rightArrow.addEventListener("click", (0, _changeSlideJs.swipeNextSlide));
leftArrow.addEventListener("click", swipePrevSlide);
sliderOutline.addEventListener("click", (0, _changeSlideJs.switchSlide));
slidesContainer.addEventListener("touchstart", (0, _touchSwipeJs.start));
slidesContainer.addEventListener("touchmove", (0, _touchSwipeJs.move));
slidesContainer.addEventListener("touchend", (0, _touchSwipeJs.end));
links.forEach((link)=>{
    link.addEventListener("click", (0, _scrollToJsDefault.default).bind(null, (0, _toggleMenuJsDefault.default)));
});
ctaBtn.addEventListener("click", (0, _scrollToJsDefault.default).bind(null, (0, _toggleMenuJsDefault.default)));

},{"core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","./createFunctions.js":"2zHNd","./changeSlide.js":"5Ocw7","./touchSwipe.js":"kprsp","./scrollTo.js":"949ks","./toggleMenu.js":"iFBSk","./animations.js":"8YYNC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
},{}],"2zHNd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createSlides", ()=>createSlides);
parcelHelpers.export(exports, "createSliderNavigation", ()=>createSliderNavigation);
...
const createSlides = function() {
    slidesContainer.innerHTML = reviews.map((r, i)=>{
        ...
        return `<li class="slide ${position}" data-slide='${i + 1}'>
                    ...
                    <span>Zdroj recenzi\xed:&nbsp;<img src="./assets/icons/${source}-logo.svg" alt="${source[0].toUpperCase() + source.slice(1)} logo"></span>
                    </li>`;
    }).join("");
};
const createSliderNavigation = function() {
    sliderNavContainer.innerHTML = reviews.map((_, i)=>{
        return `<li  ${i === 0 ? 'class="active-slide"' : ""} data-slide='${i + 1}'><span style="display: none">${i + 1}</span></li>`;
    }).join("");
};

},{"./data.js":"7GJdP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7GJdP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const reviews = [
    {
        name: "Norbert B.",
        text: "Vysoko profesion\xe1lny pr\xedstup, najlep\u0161\xed \u0161\xe9f servisu na v\xfdchodnom Slovensku a pri\u013Eahlom vesm\xedre. Ak im zver\xedte svoju l\xe1sku, postaraj\xfa sa o \u0148u ako o vlastn\xfa.",
        source: "google"
    },
    {
        name: "J\xe1n M.",
        text: "Ve\u013Emi \u0161ikovn\xfd servis. Vedia dobre a ochotne poradi\u0165 a opravia v\u0161etky typy motocyklov. Odpor\xfa\u010Dam. Parkovanie bezprobl\xe9mov\xe9. \u0160ikovn\xfd, palec hore.",
        source: "google"
    },
    {
        name: "Miroslav U.",
        text: "Ke\u010F sa spoja najlep\u0161\xed s najlep\u0161\xedmi v\xfdsledok je v\u017Edy spokojnos\u0165. \u010Eakujem za servis mojej cbr1000f a gt650.",
        source: "google"
    },
    {
        name: "Tom\xe1\u0161 R.",
        text: "\xda\u017Easn\xfd servis, dobr\xfd mechanik, r\xfdchle dodanie dielov. Diagnostika trvala 4 min\xfaty a diely pri\u0161li na druh\xfd de\u0148. Za menej ako 24 hod\xedn som op\xe4\u0165 \u0161of\xe9roval ako obvykle. \xda\u017Easn\xe9!",
        source: "google"
    }
];
...
},{}],"5Ocw7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "swipeNextSlide", ()=>swipeNextSlide);
parcelHelpers.export(exports, "switchSlide", ()=>switchSlide);
const slidesContainer = document.querySelector(".slider");
const swipeNav = function(slide) {
    document.querySelectorAll(".slider-nav li").forEach(function(s) {
        s.classList.remove("active-slide");
    });
    document.querySelector(`.slider-nav li[data-slide='${slide}']`).classList.add("active-slide");
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kprsp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const end = function() {
    ...
    if (endingX < startingX && startingX - endingX > 25) (0, _changeSlideJs.swipeNextSlide)();
    moving = false;
};

},{"./changeSlide.js":"5Ocw7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"949ks":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iFBSk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const menuIcon = document.querySelector(".menu-btn");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8YYNC":[function(require,module,exports) {
/* ANIMATION SECTIONS REVEAL */ const sections = document.querySelectorAll("section");
...
/* ANIMATION MOTORBIKE MOVE */ const motorbike = document.querySelector(".after");
...
const moveOnScroll = function() {
    ...
    motorbike.style.backgroundPosition = startPosition - scrollPosition * changePerPixel + "%";
};
window.addEventListener("scroll", moveOnScroll);

},{}]},["5ZWem","6Bv9J"], "6Bv9J", "parcelRequire94c2")
